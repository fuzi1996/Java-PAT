package cn.pintia;
/**
 * 未完成：1003,1007,1008,1010,1076,1077,1078,1082,1090
 * 超时：1007,1070,1080,1083,1085
 * 第一次得分                   拼尽全力后得分
 * 64                90
 * 66
 * 72
...
public class Test {
	...
	private static int CRC16_CCITT(String string) {
		int crc_reg = 0x0000;
		for (int i = 0; i < string.length()-1; i+=2) {
			int pSrcData = Integer.parseInt(string.substring(i, i+2), 16);
	...
	public static void main(String[] args) {
		byte [] bytes = new byte []{0x30,0x01,0x00,0x01,0x01,0x33,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x02,0x02,0x05};
		int re = CRC16_ccitt(bytes);
		System.out.println(Integer.toHexString(re).toUpperCase());
		
		String teString = "30 01 00 01 01 33 00 00 00 00 00 00 01 00 02 02 05".trim().replace(" ", "");
		int reR = CRC16_CCITT(teString);
		System.out.println(Integer.toHexString(reR).toUpperCase());
